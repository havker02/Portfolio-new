            ...
            <div className="flex justify-center lg:justify-end animate-in slide-in-from-right duration-1000">
              <div className="relative group">
                ...
                <Image
                  ...
                  width={400}
                  height={400}
                  className="relative rounded-full border-4 border-background shadow-2xl group-hover:scale-105 transition-transform duration-500"
                />
              </div>
            </div>
          </div>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  <h3 className="font-semibold text-lg mb-2 group-hover:text-primary transition-colors">Project {i}</h3>
