            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                <div className="flex gap-4">
                  {[
                    { icon: Github, href: "https://github.com", color: "hover:bg-gray-900 hover:text-white" },
                    { icon: Linkedin, href: "https://linkedin.com", color: "hover:bg-blue-600 hover:text-white" },
                    { icon: Twitter, href: "https://twitter.com", color: "hover:bg-blue-400 hover:text-white" },
                  ].map((social, index) => (
                    <Link
                      key={index}
                      href={social.href}
